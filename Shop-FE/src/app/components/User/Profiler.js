...
const Profile = ({ history }) => {
  ...
  const Logout = () => {
    dispatch(logout());
    // history.push("/");
    alert.success("Logout Success Fully");
  };
    ...
    <Fragment>
      {loading ? (
        ...
        <Fragment>
          ...
          {/* <div className="profileContainer">
            <div>
              ...
              <img
                ...
                alt={user.name}
              />
              <Link to="/me/update">Chỉnh sữa thông tin</Link>
            </div>
            <div>
              <div>
                <h4>Họ và tên</h4>
              ...
              <div>
                ...
                <Link to="/password/update">Mật khẩu</Link>
                <Link to="/login" >Đăng xuất</Link>
                <button className="CheckoutBtn" onClick={Logout}>
                  Đăng xuất
                </button>
              </div>
            </div>
            ...
            <div class="profile-card js-profile-card">
              ...
              <div class="profile-card__cnt js-profile-cnt">
                ...
                <div class="profile-card__txt">
                  {(user.role === "admin") & (user.name === "Phạm Vĩnh Lộc")
                    ? "Web Developer"
                    : "Email:"}{" "}
                ...
                <div class="profile-card-inf">
                  <div class="profile-card-inf__item">
                    ...
                    <div class="profile-card-inf__txt">Tham Gia</div>
                  </div>

                  <div class="profile-card-inf__item">
                    <div class="profile-card-inf__title">{user.role}</div>
                    <div class="profile-card-inf__txt">Chức vụ</div>
                  </div>

                  <div class="profile-card-inf__item">
                    <div class="profile-card-inf__title">
                      {(String(user.resetPasswordExpire) === "undefined"
                        ? "Không có"
                        : user.resetPasswordExpire
                      ).substr(0, 10)}
                    </div>
                    <div class="profile-card-inf__txt">
                      Đổi mật khẩu gần đây
                    </div>
                  </div>
                ...
                <div class="profile-card-social">
                  <a
                    href="https://www.facebook.com/Loc.i.am105"
                  ...
                  <a
                    href="https://www.instagram.com/loc.i.am"
                ...
                <div class="profile-card-ctr">
                  <button class="profile-card__button button--blue js-message-btn">
                    <a style={{ color: "white" }} href="/password/update">
                      Đổi mật khẩu
                    </a>
                  </button>
                  <button
          ...
          <svg hidden="hidden" className="svg-icon">
            <defs>
